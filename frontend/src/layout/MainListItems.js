  ...
  return (
    <div onClick={drawerClose}>
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
        <a href="https://comunidadezdg.com.br/" target="_blank" rel="noopener noreferrer" style={{ display: 'block', textAlign: 'center' }}>
          <img src={chatImage} style={{ width: '40%', margin: 'auto' }} alt={process.env.REACT_APP_TITLE} />
        </a>
